...
~$2.00 total across the smoke test and the live batteries (all five
D5(b) models, the D2(b) descriptor v1/v2 pair, and the D2(b) return-shape
v1/v2 pair, current 50-case set) — comfortably inside the $3/member and
$10 course-wide budget lines.
